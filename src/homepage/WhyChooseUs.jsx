...
const WhyChooseUs = () => {
    return (
        <div className='bg-[#f3ecec] pb-20'>
            <h1 className='text-center font-bold text-5xl py-20' >WHY CHOOSE US</h1>
            <div className='xl:max-w-7xl lg:max-w-4xl  md:max-w-3xl sm:max-w-xl max-w-sm mx-auto flex lg:flex-row flex-col lg:gap-20 gap-12'>
                <div>
                    <h1 className='font-bold text-4xl pb-10'>{"Keyword,Research Strategy, Survey, & Analytics".toUpperCase()}</h1>
                ...
                <div className='space-y-9'>
                    <div className='flex justify-center items-center gap-7'>
                        <div>
                            <h1 className='size-40 border-3 border-black rounded-full flex justify-center items-center text-4xl font-bold'>60%</h1>
                        </div>
                        <div>
                            <h1 className='text-3xl font-bold'>STRATEGY</h1>
                            <p className='font-semibold w-60 mt-5'>Your marketing strategy optimizing performances doesn’t have to be a guessing game.</p>
                    ...
                    <div className='flex justify-center items-center gap-7 lg:relative lg:-translate-x-12 sm:-translate-x-20'>
                        <div>
                            <h1 className='size-40 border-3 border-black rounded-full flex justify-center items-center text-4xl font-bold'>95%</h1>
                        </div>
                        <div>
                    ...
                    <div className='flex justify-center items-center gap-7'>
                        <div>
                            <h1 className='size-40 border-3 border-black rounded-full flex justify-center items-center text-4xl font-bold'>70%</h1>
                        </div>
                        <div>
